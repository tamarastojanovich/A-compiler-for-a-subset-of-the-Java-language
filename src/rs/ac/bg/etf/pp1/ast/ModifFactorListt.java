...
public class ModifFactorListt extends ModifFactorList {

    private ModifFactorList ModifFactorList;
    private Factor Factor;

    public ModifFactorListt (ModifFactorList ModifFactorList, Factor Factor) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ModifFactorListt(\n");

...
public class ConstructorDeclListMany extends ConstructorDeclList {

    private ConstructorDeclList ConstructorDeclList;
    private ConstructorDecl ConstructorDecl;

    public ConstructorDeclListMany (ConstructorDeclList ConstructorDeclList, ConstructorDecl ConstructorDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstructorDeclListMany(\n");

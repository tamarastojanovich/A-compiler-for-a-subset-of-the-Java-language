...
public class FactorDesignatorFunParams extends Factor {

    private DesignatorName DesignatorName;
    private DesignatorParams DesignatorParams;

    public FactorDesignatorFunParams (DesignatorName DesignatorName, DesignatorParams DesignatorParams) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorDesignatorFunParams(\n");
